...
ERP_STRUCTURE = [
    ...
    },
    {
        ...
        "modules": [
            {"code": "boq", "name": "BOQ", "route": "/estimation/boq/", "icon": "list", "order": 1},
            {
                "code": "quotations",
                "name": "Quotations",
                "route": "/estimation/quotations",
                "icon": "file-pencil",
                "order": 2,
            },
            {
                "code": "quatation_template",
                "name": "Templates Items",
                "route": "/estimation/template/",
                "icon": "template",
                "order": 3,
            },
            {
                ...
                "route": "/estimation/quote-to-order",
                "icon": "arrow-right",
                "order": 4,
            },
        ],
        ...
        "modules": [
            {
                "code": "all_projects",
                "name": "All Projects",
                "route": "/project/project-creation/",
                "icon": "folder",
                "order": 1,
            },
            {
    ...
    },
    {
        ...
        "modules": [
            {
                "code": "site_measurement",
                "name": "Site Measurement Tool",
                "route": "/design/site-measurement",
                "icon": "ruler",
                "order": 1,
            },
            {
    ...
    },
    {
        ...
        "modules": [
            ...
            },
            {
                ...
                "route": "/procurement/inventory-dashboard",
                "icon": "pie-chart",
                "order": 5,
            },
            {
                "code": "material_settings",
                "name": "Material Settings",
                "route": "/inventory/material-settings/",
                "icon": "settings-2",
                "order": 6,
            },
            {
            ...
            },
            {
                ...
                "name": "Stock Movement",
                "route": "/procurement/stock-movements",
                "icon": "move",
                "order": 8,
            },
            {
                "code": "inventory_checklist",
                "name": "Checklist Inventory",
                "route": "/inventory/inventory-checklist/",
                "icon": "list-check",
                "order": 9,
            },
            {
            ...
            },
            {
                ...
                "route": "/procurement/inventory-valuation",
                "icon": "dollar-sign",
                "order": 11,
            },
            {
            ...
            },
            {
                ...
                "name": "Project-wise Allocation",
                "route": "/procurement/project-allocation",
                "icon": "tag",
                "order": 13,
            },
        ],
    },
    {
        ...
        "modules": [
            ...
            },
            {
                ...
                "name": "Production Order (Job Card)",
            ...
            },
            {
                "code": "labor_tracking",
                "name": "Labor Tracking",
                "route": "/production/labor-tracking",
                "icon": "user-check",
                "order": 4,
            },
            {
            ...
            },
            {
                ...
                "route": "/production/checklist/",
                "icon": "list-check",
                "order": 6,
            },
            {
                "code": "rework",
                "name": "Rejection & Rework Management",
    ...
    },
    {
        ...
        "modules": [
            ...
            {
                "code": "dispatch_planning",
                "name": "Dispatch Planning",
                "route": "/logistics/dispatch-planning",
                "icon": "truck",
                "order": 2,
            },
            {
                ...
                "route": "/logistics/delivery-challan",
                "icon": "file",
                "order": 3,
            },
            {
                ...
                "route": "/logistics/shipment-tracking",
                "icon": "map-pin",
                "order": 4,
            },
        ],
    },
    {
        ...
        "modules": [
            {
                "code": "installation_schedule",
                "name": "Installation Scheduling",
                "route": "/installation/installation-schedule",
                "icon": "calendar",
                "order": 1,
            },
            {
                "code": "intsallation-labor-tracking",
                "name": "Labor Tracking",
                "route": "/installation/intsallation-labor-tracking/",
                "icon": "user-check",
                "order": 2,
            },
            {
                "code": "site_inventory",
                "name": "Site Inventory Management",
                "route": "/installation/site-inventory",
                "icon": "archive",
                "order": 3,
            },
            {
                "code": "installation_checklist",
                "name": "Installation Checklist",
                "route": "/installation/installation-checklist",
                "icon": "check-square",
                "order": 4,
            },
            {
                "code": "installation_task",
                "name": "Tasks",
                "route": "/installation/tasks/",
                "icon": "check-square",
                "order": 5,
            },
            {
                "code": "installation_rework",
                "name": "Rework Installation",
                "route": "/installation/rework/",
                "icon": "rotate-cw",
                "order": 6,
            },
            {
    ...
    },
    {
        ...
        "modules": [
            {
                "code": "vehicle_database",
                "name": "Vehicle Database",
                "route": "/vehicle/vehicle-database/",
                "icon": "car-garage",
                "order": 1,
            },
            {
                "code": "trip_log",
                "name": "Trip Log",
                "route": "/vehicle/trip-log/",
                "icon": "arrows-up-down",
                "order": 2,
            },
            {
                "code": "vehicle_mainatanance",
                "name": "Vehicle Maintenance",
                "route": "/vehicle/vehicle-maintanance/",
                "icon": "settings-cog",
                "order": 3,
            },
            {
                "code": "schedule&alerts",
                "name": "Schedule & Alerts",
                "route": "/vehicle/schedule&alerts/",
                "icon": "calendar-pause",
                "order": 4,
            },
        ],
    },
    {
        ...
        "modules": [
            ...
            },
            {
                ...
                "route": "/analytics/project-analytics",
                "icon": "folder",
                "order": 2,
            },
            {
                ...
                "route": "/analytics/financial-analytics",
                "icon": "dollar-sign",
                "order": 3,
            },
            {
    ...
    },
    {
        ...
        "modules": [
            ...
            },
            {
                ...
                "route": "/core/company-profile",
                "icon": "building",
                "order": 2,
            },
            {
                "code": "branch_mgmt",
                "name": "Branch/Factory Management",
                "route": "/core/branch-management",
                "icon": "map-pin",
                "order": 3,
            },
