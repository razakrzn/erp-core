...
class SiteLog(models.Model):
    ...
    logged_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="project_site_logs",
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    ...
    class Meta:
        ...
        ordering = ["-date"]
        constraints = [models.UniqueConstraint(fields=("project", "date"), name="uniq_project_site_log_date")]
...
class Timesheet(models.Model):
    ...
    employee = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="project_timesheets")
    ...
    approved_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="approved_project_timesheets",
    )
...
class ProjectMaterial(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name="allocated_materials")
    ...
    milestone = models.ForeignKey(Milestone, on_delete=models.SET_NULL, null=True, blank=True, related_name="materials")
...
class QualityCheckpoint(models.Model):
    ...
    inspected_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="inspected_checkpoints",
    )
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="created_quality_checkpoints",
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class DXFAnalysisResult(models.Model):
    ...
    raw_data = models.JSONField(
        default=dict, blank=True, help_text="Detailed results including parts, bins, placements, and summaries."
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
