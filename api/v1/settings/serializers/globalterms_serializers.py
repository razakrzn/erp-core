...
class GlobalTermsBaseSerializer(serializers.ModelSerializer):
...
class GlobalTermsListSerializer(GlobalTermsBaseSerializer):
    class Meta:
        model = GlobalTerms
        fields = [
            "id",
...
class GlobalTermsDetailSerializer(GlobalTermsBaseSerializer):
    class Meta:
        model = GlobalTerms
        fields = [
            "id",
